...
On this page, you will create a `hash`, which is a really long code that contains all your answers. You will submit this code online. Your instructor can decode it to view your answers. Click the "Generate Submission" to get your code. 
...
Want to see what you are submitting? You can copy the code from the previous page to see how the function works. The instructor will be able to use this function to view your work. 
