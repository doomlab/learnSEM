...
Load the assignment_mirt data below. The scale included examines evaluations of job candidates rated on 15 different qualities. 
...
question_text(
  ...
  answer("Many are good, but 5, 8, 9, and 13 have low a parameters.", correct = TRUE),
  incorrect = "Many are good, but 5, 8, 9, and 13 have low a parameters.",
  try_again_button = "Modify your answer",
  allow_retry = TRUE
)
```
